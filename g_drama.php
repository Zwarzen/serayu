...
<div class="searchbar" style="position: sticky; margin-top: 20px; width: 30%;">
  <div class="search-container" style="padding-right: 160px; ">
    <form method="post" action="g_drama.php">
...
<div class="col-lg-7" style="margin: auto; width: 50%; padding: 0 0 10 0px; ">
  <div class="row">
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
      ...
      if ($pencarian != '') {
        $sql = "SELECT * FROM data WHERE title LIKE '%$pencarian%' AND dra_id!=0";
        $query = $sql;
        $queryJml = $sql;
      }
    } else {
      $query = "SELECT * FROM data WHERE dra_id!=0 LIMIT $posisi, $batas";
      $queryJml = "SELECT * FROM data WHERE dra_id!=0";
      $no = $posisi + 1;
    }
